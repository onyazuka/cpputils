...
void util::tests::testLogger() {
	StreamLogger slog(Logger::LogLevel::warning, Logger::Options(true, false, false, true, true), std::cout);
	...
	slog.setOptions(Logger::Options(true, false, false, false, false));
	slog.info("info here again");

	std::string ss = "err";
	FileLogger flog(Logger::LogLevel::warning, Logger::Options(true, false, false, true, true), "d:/1.txt");
	...
	StreamSingletonLogger::init(Logger::LogLevel::warning, Logger::Options(true, false, false, true, true), std::cout);
	...
	FileSingletonLogger::init(Logger::LogLevel::debug, Logger::Options(true, false, false, true, true), "d:/2.txt", std::ios_base::app);
	FileSingletonLogger::get().debug("hi");

	std::unique_ptr<StreamLogger> pslog = std::make_unique<StreamLogger>(Logger::LogLevel::warning, Logger::Options(true, true, true, true, true), std::cout);
	std::unique_ptr<FileLogger> pslog1 = std::make_unique<FileLogger>(Logger::LogLevel::warning, Logger::Options(true, false, false, true, true), "d:/3.txt", std::ios_base::app);
